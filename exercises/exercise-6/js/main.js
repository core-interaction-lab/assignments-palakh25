const fetchMovies = async () => {
    const response = await fetch('https://api.airtable.com/v0/appxfJxfQb92yyKkg/movies?maxRecords=100&view=Grid%20view&api_key=keyzJ9RlZVLsdVb9O').then(data => data.json());
